<template>
    <b-modal v-model="showModal" hide-footer header-class="p-3 bg-light" style="--vz-modal-width: 600px;" class="v-modal-custom" modal-class="zoomIn" centered>
        <template v-slot:header>
            <h5 class="modal-title">Download Schools</h5>
                        ...
                        <div class="text-center">
                            ...
                            <div class="p-2 mt-4">
                                <form @submit.prevent="preview" enctype="multipart/form-data">
                                    <p v-if="!result" class="text-muted">Download all schools from the central server. This is a request to get the latest schools, campuses, and courses added.</p>
                                    <p v-else class="text-muted">Schools, campuses and courses was downloaded from central server.</p>
                                    ...
                                    <div class="row g-0 text-center" v-if="result">
                                        <div class="col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0">
                                                ...
                                                <p class="text-success fw-semibold mb-0">Schools</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span>{{failed.length}}</span></h5>
                                                <p class="text-danger fw-semibold mb-0">Campuses</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0">
